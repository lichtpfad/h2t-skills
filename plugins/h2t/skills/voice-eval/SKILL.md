...
Оценивает черновик текста на соответствие авторскому голосу. Выдаёт score, критические проблемы и prescriptions для LLM-рерайта.
...
### Оценить черновик (основной режим)
...
### Step 5 (опционально): Добавить в reference

Если текст финализирован и опубликован — предложить добавить в reference для улучшения профиля:
