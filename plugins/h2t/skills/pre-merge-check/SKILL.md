...
description: Use before merging a feature branch to main or creating a PR. Triggers on "pre-merge", "ready to merge", "готов к мерджу", or when superpowers finishing-a-development-branch is about to run. Runs security, test, and build gates., 'h2t:pre-merge-check'
