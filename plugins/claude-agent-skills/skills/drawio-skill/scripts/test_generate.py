...
# ---------------------------------------------------------------------------
print("Test 1: Basic nodes + edges ... ", end="")
graph = {
    "nodes": [
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    print(f"OK -- generated {os.path.getsize(output)} bytes")

# ---------------------------------------------------------------------------
# Test 2: Links and tooltips
# ---------------------------------------------------------------------------
print("Test 2: Links and tooltips ... ", end="")
graph2 = {
    "nodes": [
        {
            "id": "x",
...
# ---------------------------------------------------------------------------
print("Test 4: Auto-grid positioning ... ", end="")
graph4 = {
    "nodes": [
...
# ---------------------------------------------------------------------------
print("Test 5: Bidirectional edges ... ", end="")
graph5 = {
    "nodes": [
...
# ---------------------------------------------------------------------------
print("Test 6: whiteSpace=wrap;html=1 in node styles ... ", end="")
graph6 = {
    "nodes": [
...
# ---------------------------------------------------------------------------
print("Test 7: Auto-grid position coordinates ... ", end="")
graph7 = {
    "nodes": [
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    print("OK -- all 6 grid positions correct")

# ---------------------------------------------------------------------------
# Test 8: Edge color auto-resolution from _edges table
# ---------------------------------------------------------------------------
print("Test 8: Edge color auto-resolution ... ", end="")
graph8 = {
    "nodes": [
...
# ---------------------------------------------------------------------------
print("Test 10b: _read_existing with UserObject-wrapped node ... ", end="")
...
# ---------------------------------------------------------------------------
print("Test 15: Edge source/target refs updated after ID injection ... ", end="")
