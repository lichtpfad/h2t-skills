...
description: "LLM-enrichment of MeetGeek meeting transcripts. Extracts participants, summary, action items, decisions, routes personal/coaching sessions to SELFWORK. Triggers: 'process transcripts', 'обработай транскрипты', 'enrichment meetings'."
