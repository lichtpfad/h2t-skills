...
| Route all provider I/O (Drive, Gmail, Calendar, Notion, Telegram, MeetGeek) through h2t-ops connector | `deferred:skill` | h2t-skills | `C:/dev/h2t-skills/.claude/rules/connectors.md`, `C:/Users/stani/.claude/projects/C--dev-h2t-skills/memory/reference_meetgeek_upload_flow.md` |
| Preserve the user's query language in neural/Exa searches; do not translate a non-English query | `deferred:skill` | h2t-skills | `C:/Users/stani/.claude/projects/C--dev-h2t-skills/memory/feedback_preserve_query_language.md` |
...
| practice | verdict | lineages | source |
|---|---|---|---|
| Deploy plugin changes via commit → git push → marketplace update → reload (never update-plugin.sh as final) | `deferred:code` | h2t-skills | `C:/dev/h2t-skills/.claude/rules/plugin-deploy.md`, `C:/Users/stani/.claude/projects/C--dev-h2t-skills/memory/feedback_plugin_reload.md` |
| Two-gate / staged verdict split (cheap screen gate then confirm gate, distinct verdict per gate) | `deferred:code` | crypto-regime-spike, quant-kb | `C:/dev/crypto-regime-spike/docs/superpowers/plans/2026-06-27-plan4-statistical-multiplicity-oos.md`, `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-quant-kb-plan16-two-gate-verdict-2026-07-10.md` |
...
| Multi-judge consensus panel for adjudicating extracted claims (parallel judges, majority vote, aggregated deterministically) | `deferred:code` | quant-kb, crypto-regime-spike, rejuve | `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-kb-plan9-council-rekey-2026-07-07.md`, `C:/work/rejuve/docs/superpowers/plans/2026-07-03-jtbd-segmentation.md`, `C:/dev/crypto-regime-spike/docs/superpowers/specs/2026-06-15-passport-conventions-v2.md` |
| Pre-registration / freeze-before-run + append-only immutable ledger for honest multiplicity accounting | `deferred:code` | crypto-regime-spike, quant-kb | `C:/Users/stani/.h2t/sessions/AUTOMATA/crypto-regime-spike/crypto-regime-spike-multiplicity-denominator-2026-06-27.md`, `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-kb-operator-freeze-2026-07-08.md` |
| Known-answer / byte-identical golden anchor pinned as a mutation-detecting regression tripwire across every merge | `deferred:code` | crypto-regime-spike, quant-kb | `C:/Users/stani/.h2t/sessions/AUTOMATA/crypto-regime-spike/crypto-regime-spike-money-hypoth-plan4-2026-06-27.md`, `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-kb-plan6-typization-2026-07-06.md` |
| Per-run telemetry / cost run-ledger emitted from real usage (shared by benchmark + production runs, not estimates) | `deferred:code` | crypto-regime-spike, quant-kb | `C:/Users/stani/.h2t/sessions/AUTOMATA/crypto-regime-spike/crypto-regime-spike-pr76-merge-2026-07-09.md`, `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-kb-plan19-sonnet-extract-2026-07-09.md` |
| LLM-extraction model/config benchmarking with golden-ref scoring + per-stage evaluability | `deferred:code` | quant-kb | `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-kb-plan19-benchmark-2026-07-09.md`, `C:/Users/stani/.h2t/sessions/AUTOMATA/quant-kb/quant-kb-ingest-model-benchmark-2026-07-09.md` |
| Fail-closed autonomy guard: autonomous agent capped to a status ceiling (MACHINE_CANDIDATE/KILL) with mechanical never-false-GO asserts + frozen manifest | `deferred:code` | crypto-regime-spike | `C:/Users/stani/.h2t/sessions/AUTOMATA/crypto-regime-spike/crypto-regime-spike-money-hypoth-phase1-2026-07-04.md` |
| PIT / look-ahead temporal-leakage guard: explicit available_time convention + pin-test that a value on date D uses only data known by D | `deferred:code` | crypto-regime-spike | `C:/Users/stani/.h2t/sessions/AUTOMATA/crypto-regime-spike/crypto-regime-spike-money-hypoth-phaseB-2026-07-03.md` |
...
| Read a document's actual content before citing it; grep the codebase for a name/number/quote before asserting it exists | evidence-grounded-synthesis.md | `C:/work/rejuve/.claude/rules/evidence-rules.md`, `C:/Users/stani/.claude/projects/C--dev-h2t-skills/memory/project_tracker_lags_code.md` |
