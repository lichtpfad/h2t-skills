...
def register(subparsers: Any) -> None:
    ...
    tp.add_argument("--query", default=None)
    add_fmt(tp)

    thp = cmds.add_parser("thread", help="Read a thread")
    thp.add_argument("thread_id")
    add_fmt(thp)
    ...
    dp.add_argument("--reply-to", dest="reply_to")
    add_fmt(dp)
    ...
    lbl = cmds.add_parser("labels", help="List all labels")
    add_fmt(lbl)

    lm = cmds.add_parser("label", help="Modify message labels")
    lm.add_argument("message_id")
    lm.add_argument("--add", nargs="+")
    lm.add_argument("--remove", nargs="+")
    add_fmt(lm)
