...
def register(subparsers: Any) -> None:
    ...
    gd.add_argument("database_id")
    gd.add_argument("--limit", type=int)
    add_fmt(gd)
    ...
    c.add_argument("parent_id")
    c.add_argument("title")
    c.add_argument("--content")
    c.add_argument("--file")
    c.add_argument("--database", action="store_true")
    add_fmt(c)
    ...
    sy.add_argument("page_id")
    sy.add_argument("output_file")
    ...
    vl.add_argument("--database-id")
    vl.add_argument("--data-source-id")
    vl.add_argument("--limit", type=int)
    add_fmt(vl)
    vg = vsub.add_parser("get", help="Read one view: sorts, filter, configuration")
    vg.add_argument("view_id")
    add_fmt(vg)
    ...
    vc.add_argument("--database-id")
    vc.add_argument("--data-source-id")
